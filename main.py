    ...
    def set_webhook():
        bot.remove_webhook()
        bot.set_webhook(url='https://vita-production-7c0a.up.railway.app/webhook')  # Замените на свой URL
        return "Webhook set!", 200

    # Webhook для обработки запросов от Telegram
    ...
    # Функция для инициализации потоков и начала работы планировщика
    def start_app():
        load_user_states()  # Загружаем состояние пользователей
